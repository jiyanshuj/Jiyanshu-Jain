...
const certData: Cert[] = [
  ...
  { id: 18, org: "Research Papers", color: "#8b5cf6", title: "Campus Cloud Network – AI & ML Based College Management", description: "Presented at AVDHARAN 2025, 5th International Conference on Intelligent, Sustainable, Social and Secure Computing, Shri Vaishnav Vidyapeeth Vishwavidyalaya, Indore.", date: "Dec 2025" },
  { id: 19, org: "Research Papers", color: "#8b5cf6", title: "Birddex: An Intelligent Mobile-Based Bird Identification System", description: "Presented at AVDHARAN 2025, 5th International Conference on Intelligent, Sustainable, Social and Secure Computing, Shri Vaishnav Vidyapeeth Vishwavidyalaya, Indore.", date: "Dec 2025" },
  { id: 20, org: "SVVV, Indore", color: "#6c3fc5", title: "Technical Quiz Organizer", description: "Led the organization of a campus-wide technical quiz, fostering knowledge-sharing and technical skill development.", date: "Jun 2024" },
  { id: 21, org: "Unstop", color: "#ff6b35", title: "IGNITE 180 3.0 – Global Strategy Challenge", description: "Participated as Team 'the coder boyZ' in the Global Strategy Challenge at IGNITE 180 3.0, KMC, University of Delhi.", date: "2024" },
  { id: 22, org: "Chameli Devi Group", color: "#10b981", title: "Hack Wave Hackathon Finalist", description: "Advanced to the final round with the Sustainable Travel Planner project, demonstrating innovation and sustainability-focused development.", date: "Apr 2024" },
];
